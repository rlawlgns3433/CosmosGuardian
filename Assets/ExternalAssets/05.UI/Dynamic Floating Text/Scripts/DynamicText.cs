...
public class DynamicText : MonoBehaviour
{
    ...
    private List<bool> entered; // array to track progress of all entries
    ...
    void Exit()
    {
        if (data.exitType == ExitType.Fade)
        {
            ...
            {
                ResetText();
                DynamicTextManager.ReturnText(gameObject);
            }
    ...
    private void ResetText()
    {
        ...
        initialised = false; // set to true af
        entered.Clear(); // array to track progr
        completeEntered = true; // above array
        exit = false; // used to track whether
        despawnStarted = false; // used to run
        ...
        startScaleZero = Vector3.zero;
        startColour = default;
        startColourNoOpacity = default;
        direction = default;
